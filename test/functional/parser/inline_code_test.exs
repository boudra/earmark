defmodule Parser.InlineCodeTest do
  ...
  test "Even number of inline code" do
    result = parse_markdown(["third` suffix`"])
  ...
  test "Escapes and Backtix" do
    result = parse_markdown(["\\\\` more \\\\\\`code\\\\`"])
  ...
  test "Escapes and Backtix and Code" do
    result = parse_markdown(["\\\\` more \\\\\\`code\\\\`", "    Hello"])

    expected = [
      %Earmark.Block.Para{attrs: nil, lines: ["\\\\` more \\\\\\`code\\\\`", "    Hello"], lnb: 1},
    ]
